...
export const CMS_MEDIA_BASE = process.env.NEXT_PUBLIC_CMS_MEDIA_BASE ?? '';

/** Fallback image URL when WP featured media is missing (cards, grids). */
export const FALLBACK_FEATURED_IMAGE =
  `${CMS_MEDIA_BASE}/wp-content/uploads/2021/09/20210830_VacijasVestnieciba_VagneraZale_039-650x433.jpg`;
