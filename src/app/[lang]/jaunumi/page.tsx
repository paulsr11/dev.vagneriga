...
export const metadata: Metadata = {
  title: 'Jaunumi - Vagneriga',
  description: 'Vāgnera Biedrības jaunumi un aktualitātes',
};

interface JaunumiPageProps {
...
export default async function JaunumiPage({ params, searchParams }: JaunumiPageProps) {
  ...
  const page = await getPageBySlug('jaunumi');
  const acf = page?.acf || {};

  const pageData = {
    title: getTranslatedField(acf, 'title', lang, "Jaunumi"),
