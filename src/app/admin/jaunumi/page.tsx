...
export default function JaunumiAdmin() {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      setIsSaving(false);
      alert("Jaunumu lapas saturs saglabāts!");
    }, 1000);
  };
    ...
    <div className="min-h-screen bg-gray-50 p-8 pt-32">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        <div className="bg-zinc-900 p-8 text-white flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold">Jaunumu lapa</h1>
        ...
        <div className="p-8 space-y-10">
          <section>
            ...
            <p className="mt-6 text-sm text-gray-500 italic">
              Piezīme: Paši jaunumu raksti tiek pārvaldīti caur WordPress "Posts" sadaļu.
            </p>
          </section>
        </div>
      </div>
