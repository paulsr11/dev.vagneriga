      ...
      <section className="vag-container pt-8 pb-16">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2">
            <div 
              className="relative aspect-[4/3] w-full min-h-[280px] sm:min-h-[340px] md:min-h-[380px] overflow-hidden shadow-xl border border-gray-100 group rounded-[var(--card-radius)]"
            >
              <Image 
                src={heroData.image}
                alt={heroData.title}
