...
function InfoCard({ title, subtitle, image }: InfoCardProps) {
  return (
    <div 
      className="relative group h-full min-h-[320px] cursor-pointer overflow-hidden bg-[#002142]"
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-[#002142]/20" />
      <div className="relative flex h-full flex-col justify-end p-10 text-white">
        ...
        <div className="mt-4 flex justify-end">
           <span className="text-[#B49661] text-4xl leading-none">›</span>
        </div>
      </div>
    </div>
  );
